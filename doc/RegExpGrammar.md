...
CLASS = CLASS_START CLASS_BODY CLASS_END
CLASS_START = T_LEFT_SQUARE_BRACKET
CLASS_END = T_RIGHT_SQUARE_BRACKET
CLASS_INVERTER = T_CIRCUMFLEX
CLASS_BODY = [CLASS_INVERTER] FIRST_CLASS_ITEM *CLASS_ITEM
...
ESC_SEQUENCE = ESC_SIMPLE / ESC_SPECIAL / ESC_NON_PRINTABLE / ESC_PROP / ESC_NOT_PROP
...
ESC_NON_PRINTABLE = ESC_CTL / ESC_OCT / ESC_HEX / ESC_UNICODE
...
ESC_NOT_PROP_MARKER = T_CAPITAL_P
...
NOT_PROP_START = ; any symbol but "{"
        ...
        / T_DIGIT_OCT / T_DIGIT_DEC / T_QUESTION /  T_CAPITAL_P / T_LEFT_SQUARE_BRACKET
        / T_BACKSLASH / T_RIGHT_SQUARE_BRACKET / T_CIRCUMFLEX / T_SMALL_C / T_SMALL_O / T_SMALL_P / T_SMALL_U
        / T_SMALL_X / T_VERTICAL_LINE
...
NOT_PROP_FINISH = ; any symbol but "}"
        ...
        / T_DIGIT_OCT / T_DIGIT_DEC / T_QUESTION / T_CAPITAL_P / T_LEFT_SQUARE_BRACKET
        / T_BACKSLASH / T_RIGHT_SQUARE_BRACKET / T_CIRCUMFLEX / T_SMALL_C / T_SMALL_O / T_SMALL_P / T_SMALL_U
        / T_SMALL_X / T_LEFT_CURLY_BRACKET / T_VERTICAL_LINE
        / T_CTL_ASCII / T_OTHER_HEX_LETTER / T_OTHER_ASCII_LETTER / T_PRINTABLE_ASCII_OTHER / T_OTHER_ASCII / T_NOT_ASCII        

UNESC_SYMBOL = ; available without escaping
        T_COMMA / T_HYPHEN / T_DIGIT_ZERO / T_DIGIT_OCT / T_DIGIT_DEC / T_CAPITAL_P
        / T_RIGHT_SQUARE_BRACKET / T_CIRCUMFLEX / T_SMALL_C / T_SMALL_O / T_SMALL_P / T_SMALL_U / T_SMALL_X 
        / T_RIGHT_CURLY_BRACKET / T_CTL_ASCII
...
LIMIT_END = T_RIGHT_CURLY_BRACKET
...
PRINTABLE_ASCII = META_CHAR / DEC_DIGIT / ASCII_LETTER / PRINTABLE_ASCII_OTHER
PRINTABLE_ASCII_OTHER = T_PRINTABLE_ASCII_OTHER
...
T_OTHER_ASCII_LETTER = %x47-4F / %x51-5A / %x67-6E / %x71-74 / %x76-77 / %x79-7A ; all remaining ASCII letters
